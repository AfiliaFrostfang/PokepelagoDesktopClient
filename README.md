...
4. **Build a desktop package**:
   ...
   **Building for macOS:**
   ...
   > Note: It is highly recommended to build macOS packages on a real macOS machine or via GitHub Actions to get a properly signed `.dmg` file.
...
I use AI while developing Pokepelago Features and maintaining the Desktop Client. It helps with implementation, debugging, and review, while I make the design decisions and test releases in the Electron Build.. The project does not use AI-generated art. I am disclosing this because I want people to know how the project is made. I have Autism and probably undiagnosed ADHD.
