 ...
 *
 * Mirror of the APWorld gate-classification sets. The live gate logic now reads the
 * server-sent classification from slot_data (DEVEX-15); these bundled sets are the
 * legacy fallback (src/data/gateCategories.ts) and the DexGrid category filter.
